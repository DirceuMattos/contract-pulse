    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="resumo" className="space-y-4">
        <TabsList>
          ...
          {(userRole === 'c-level' || userRole === 'demo' || userRole === 'superadmin' || userRole === 'administrativo') && <TabsTrigger value="timeline"><Clock className="h-4 w-4 mr-2" />Linha do Tempo</TabsTrigger>}
