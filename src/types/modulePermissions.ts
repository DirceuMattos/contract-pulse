...
export const DEFAULT_ACTION_FLAGS_BY_ROLE: Record<UserRole, ActionFlags> = {
  ...
  // Head de Área: só abre a própria requisição de equipamento.
  head: { can_edit: false, can_create: true, can_delete: false, can_export: false, can_view_values: false, can_view_hr_costs: false, can_allocate: false },
};
