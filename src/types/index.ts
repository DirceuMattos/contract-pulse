...
// User and Auth Types
export type UserRole = 'c-level' | 'intermediario' | 'leitor' | 'comercial' | 'lider_tribo' | 'juridico' | 'rh' | 'administrativo' | 'demo' | 'superadmin' | 'coordenacao_suporte' | 'projetos_produtos' | 'head';
