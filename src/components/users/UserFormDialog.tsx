...
const userFormSchema = z.object({
  ...
  role: z.enum(['c-level', 'intermediario', 'leitor', 'comercial', 'lider_tribo', 'juridico', 'rh', 'administrativo', 'demo', 'superadmin', 'coordenacao_suporte', 'projetos_produtos', 'head'] as const),
  active: z.boolean(),
});
