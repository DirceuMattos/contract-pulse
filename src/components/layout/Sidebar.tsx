...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/equipamentos', label: 'Controle de Equipamentos', icon: Laptop, moduleKey: 'EQUIPMENT' },
      {
      ...
      { path: '/adm-transportes', label: 'Adm Deslocamentos (Aplicativo)', icon: Truck, moduleKey: 'TRANSPORT' },
    ],
  },
  {
    label: 'Setup',
