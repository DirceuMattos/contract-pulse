...
export async function generatePptx(input: GeneratePptxInput): Promise<void> {
  ...
  if (!isHidden(sections["sumario"] ?? {})) {
    ...
    headerBar(s, "Sumário");
    const sumItems = [
      "Objetivo do relatório", "Glossário de Termos Técnicos", "Indicadores deste Relatório",
      "Painel executivo", "Histórico evolutivo do Termo de Referência",
      "Histórico TR — Aderência Global", "Ambientes Implementados",
      ...
      "Desempenho da Aplicação", "Engajamento e Experiência do Usuário",
      "Maturidade e Gestão da Plataforma", "Treinamentos / Reuniões",
  ...
  // ── SLIDE 9: AMBIENTES IMPLEMENTADOS ──────────────────────────────────────
  {
  ...
  // ── SLIDE 10: AMBIENTES — DETALHAMENTO ────────────────────────────────────
  {
  ...
  // ── SLIDE 14: DEMONSTRATIVO DE HORAS ──────────────────────────────────────
  {
  ...
  // ── SLIDE 15: EFICIÊNCIA OPERACIONAL ──────────────────────────────────────
  {
  ...
  // ── SLIDE 16: EFICIÊNCIA E PREVISIBILIDADE ────────────────────────────────
  {
  ...
  // ── SLIDE 17: DESEMPENHO DA APLICAÇÃO (com gauge) ─────────────────────────
  {
  ...
  // ── SLIDE 18: ENGAJAMENTO DO USUÁRIO ──────────────────────────────────────
  {
  ...
  // ── SLIDE 19: MATURIDADE DA PLATAFORMA ────────────────────────────────────
  {
  ...
  // ── SLIDE 20: TREINAMENTOS / REUNIÕES ─────────────────────────────────────
  {
  ...
  // ── SLIDE 21: OPORTUNIDADES E FATORES DE ATENÇÃO ──────────────────────────
  {
